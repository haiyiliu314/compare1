...
!                                                 sigmat_A = 0.2d0*scale1, tstart_A = -0.5d0*scale1  
  ...
  double precision, parameter                  ::Ebind = 4.18d0, gamma = 0.19d0/Ebind, Eg = 1.50d3, decay_m =100d0
  ...
  double precision, parameter                  ::omega_1s = (0d0)/hbar, &    
                                                 ...
                                                 A_freq_para = (Eg-3.74657967451741d0*Ebind)/hbar
